...
```json
{
  ...
  "problem_contract": {
    ...
    "domain": {
      "description": "Draft source observation in Algebra; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:um-amr-014-0013-algebraic-stories-lefschetz-properties-6e9a7cf3",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-014-0013-c03d6a9b3e6f",
        "url": "https://www.unsolvedmath.com/problems/AMR-014-0013"
      }
    ],
    "statement": {
      "language": "en",
      "text": "When are the WLP and the SLP true for $T_{n,d,k}$?",
      "version": 1
    },
    "title": "Algebraic Stories — Lefschetz properties of graded algebras",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "fc2020b59346f9794c433a17c8e3ff83cb5bc65c2602b8947a99cc28931c4085"
}
```
